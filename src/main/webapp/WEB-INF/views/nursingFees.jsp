...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
		<h3 style="color: white;">Nursing Charges</h3>
	...
	<div class="container" style="margin-left:10%; margin-top:5%;font-size=2rem;float:left">
	  <table align="center">
	   ...
	   <tr>
	   <td>Room Type:&nbsp;&nbsp;&nbsp;</td>
	   <td>${patient.roomType}<td></tr>
	   <tr>
	   <td>Room Charges:&nbsp;&nbsp;&nbsp;</td>
	   <td>${patient.roomCharges}<td></tr>
	   <tr>
	   <td>Tariff:&nbsp;&nbsp;&nbsp;</td>
	   <td>${patient.tariff}<td></tr>
	   <tr>
	   <td>No of Days:&nbsp;&nbsp;&nbsp;</td>
	   <td>${patient.noOfDays}<td>
	   </tr>
	   <tr>
