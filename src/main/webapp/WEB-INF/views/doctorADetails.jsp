...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		<h3 style="color: white;">Doctor pending List - Approve / Deny</h3>
		...
		<table border="1" width="90%" align="center" cellpadding="5"
			...
			<c:forEach items="${doctorList}" var="doctor">
				<tr>
					...
					<td><div>
							<a href="/acceptedDoctor/${doctor.d_Id}" id="accept"
								class="btn btn-primary" type="submit">Accept</a> <a
								href="/deniedDoctor/${doctor.d_Id}" id="deny"
								class="btn btn-primary" type="submit">Deny</a>
						</div></td>
				</tr>
			</c:forEach>
	...
	<br>
	<h3 style="text-align: center">${doctor}${msg}</h3>
	<br>
	<br>
	<br>
	<br>
	<a href="/doctorADetails" style="margin-left: 5%;"
