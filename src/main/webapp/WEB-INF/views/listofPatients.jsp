...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
			...
			<form:form action="/patientReg" method="get" modelAttribute="doctor">
				<div style="margin-left: 60rem">
					<input name="add" id="add" class="btn btn-primary"
...
.btn a{
 ...
 color: whitesmoke;
        ...
        <div class="main">
            ...
            <tr>
                <td style="font-size: 20px; font-weight: bold" colspan="7">Patients List</td>
            </tr>
            <tr>
           ...
           <c:forEach items="${patientList}" var="patient">
                <tr>
                   ...
                   <td>${patient.p_Id}</td>
                    ...
                    <td><div>
                            <a href="/editpatient/${patient.p_Id}" id="editpatient" class="btn btn-primary"
